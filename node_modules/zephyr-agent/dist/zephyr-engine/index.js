...
class ZephyrEngine {
    ...
    constructor(options) {
        ...
        this.env = { isCI, buildEnv: isCI ? 'ci' : 'local', target: 'web' };
    ...
    static defer_create() {
        ...
        const zephyr_engine_defer = new Promise((r) => {
            zephyr_defer_create = (options) => r(ZephyrEngine.create(options));
        });
     ...
     *   or `android`
     */
    async resolve_remote_dependencies(deps, platform) {
        if (!deps) {
            return null;
        }
...
function readPackageJson(root) {
    ...
    const packageJsonContent = (0, fs_1.existsSync)(packageJsonPath)
