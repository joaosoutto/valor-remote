...
export declare function getBuildStats<ZephyrAgentProps extends KnownAgentProps>({ stats, stats_json, pluginOptions, EDGE_URL, DOMAIN, PLATFORM, TYPE, DELIMITER: delimiter, }: ZephyrAgentProps & {
    EDGE_URL: string;
    DOMAIN?: string;
    PLATFORM?: string;
    TYPE?: string;
